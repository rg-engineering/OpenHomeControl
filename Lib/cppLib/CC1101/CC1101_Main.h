...
#ifndef __CCC1101_MAIN_H__
#define __CCC1101_MAIN_H__
...
//#define CC1101_VENTUSVAL_IOCFG2     0x29        // GDO2 Output Pin Configuration
#define CC1101_VENTUSVAL_IOCFG2     0x0D        // GDO2 Output Pin Configuration:  GDO2 as serial output
#define CC1101_VENTUSVAL_IOCFG1     0x2E        // GDO1 Output Pin Configuration: Tri-State
#define CC1101_VENTUSVAL_IOCFG0     0x06        // GDO0 Output Pin Configuration
#define CC1101_VENTUSVAL_FIFOTHR    0x07        // RX FIFO and TX FIFO Thresholds
#define CC1101_VENTUSVAL_SYNC1      0xB5        // Synchronization word, high byte
#define CC1101_VENTUSVAL_SYNC0      0x47        // Synchronization word, low byte
#define CC1101_VENTUSVAL_PKTLEN     0x3D        // Packet Length
#define CC1101_VENTUSVAL_PKTCTRL1   0x06        // Packet Automation Control
#define CC1101_VENTUSVAL_PKTCTRL0   0x05        // Packet Automation Control
#define CC1101_VENTUSVAL_ADDR       0xFF        // Device Address
#define CC1101_VENTUSVAL_CHANNR     0x00        // Channel Number
#define CC1101_VENTUSVAL_FSCTRL1    0x08        // Frequency Synthesizer Control
#define CC1101_VENTUSVAL_FSCTRL0    0x00        // Frequency Synthesizer Control
// Carrier frequency = 868 MHz
#define CC1101_VENTUSVAL_FREQ2_868  0x21        // Frequency Control Word, High Byte
#define CC1101_VENTUSVAL_FREQ1_868  0x62        // Frequency Control Word, Middle Byte
#define CC1101_VENTUSVAL_FREQ0_868  0x76        // Frequency Control Word, Low Byte
// Carrier frequency = 902 MHz
#define CC1101_VENTUSVAL_FREQ2_915  0x22        // Frequency Control Word, High Byte
#define CC1101_VENTUSVAL_FREQ1_915  0xB1        // Frequency Control Word, Middle Byte
#define CC1101_VENTUSVAL_FREQ0_915  0x3B        // Frequency Control Word, Low Byte
// Carrier frequency = 433 MHz
// #define CC1101_VENTUSVAL_FREQ2_433	0x10		// 0D FREQ2    *1E    21    433.92 (InterTechno Frequency)
// #define CC1101_VENTUSVAL_FREQ1_433	0xb0		// 0E FREQ1    *C4    65
// #define CC1101_VENTUSVAL_FREQ0_433	0x71		// 0F FREQ0    *EC    e8

#define CC1101_VENTUSVAL_FREQ2_433  0x10        // Frequency Control Word, High Byte //433MHz
#define CC1101_VENTUSVAL_FREQ1_433  0xA7        // Frequency Control Word, Middle Byte
#define CC1101_VENTUSVAL_FREQ0_433  0x62        // Frequency Control Word, Low Byte

#define CC1101_VENTUSVAL_MDMCFG4    0xCA        // Modem Configuration
#define CC1101_VENTUSVAL_MDMCFG3    0x83        // Modem Configuration
#define CC1101_VENTUSVAL_MDMCFG2    0x93        // Modem Configuration
#define CC1101_VENTUSVAL_MDMCFG1    0x22        // Modem Configuration
#define CC1101_VENTUSVAL_MDMCFG0    0xF8        // Modem Configuration
#define CC1101_VENTUSVAL_DEVIATN    0x35        // Modem Deviation Setting
#define CC1101_VENTUSVAL_MCSM2      0x07        // Main Radio Control State Machine Configuration
//#define CC1101_VENTUSVAL_MCSM1      0x30        // Main Radio Control State Machine Configuration
#define CC1101_VENTUSVAL_MCSM1      0x20        // Main Radio Control State Machine Configuration
#define CC1101_VENTUSVAL_MCSM0      0x18        // Main Radio Control State Machine Configuration
#define CC1101_VENTUSVAL_FOCCFG     0x16        // Frequency Offset Compensation Configuration
#define CC1101_VENTUSVAL_BSCFG      0x6C        // Bit Synchronization Configuration
#define CC1101_VENTUSVAL_AGCCTRL2   0x43        // AGC Control
#define CC1101_VENTUSVAL_AGCCTRL1   0x40        // AGC Control
#define CC1101_VENTUSVAL_AGCCTRL0   0x91        // AGC Control
#define CC1101_VENTUSVAL_WOREVT1    0x87        // High Byte Event0 Timeout
#define CC1101_VENTUSVAL_WOREVT0    0x6B        // Low Byte Event0 Timeout
#define CC1101_VENTUSVAL_WORCTRL    0xFB        // Wake On Radio Control
#define CC1101_VENTUSVAL_FREND1     0x56        // Front End RX Configuration
#define CC1101_VENTUSVAL_FREND0     0x10        // Front End TX Configuration
#define CC1101_VENTUSVAL_FSCAL3     0xE9        // Frequency Synthesizer Calibration
#define CC1101_VENTUSVAL_FSCAL2     0x2A        // Frequency Synthesizer Calibration
#define CC1101_VENTUSVAL_FSCAL1     0x00        // Frequency Synthesizer Calibration
#define CC1101_VENTUSVAL_FSCAL0     0x1F        // Frequency Synthesizer Calibration
#define CC1101_VENTUSVAL_RCCTRL1    0x41        // RC Oscillator Configuration
#define CC1101_VENTUSVAL_RCCTRL0    0x00        // RC Oscillator Configuration
#define CC1101_VENTUSVAL_FSTEST     0x59        // Frequency Synthesizer Calibration Control
#define CC1101_VENTUSVAL_PTEST      0x7F        // Production Test
#define CC1101_VENTUSVAL_AGCTEST    0x3F        // AGC Test
#define CC1101_VENTUSVAL_TEST2      0x81        // Various Test Settings
#define CC1101_VENTUSVAL_TEST1      0x35        // Various Test Settings
#define CC1101_VENTUSVAL_TEST0      0x09        // Various Test Settings
...
protected:
private:
	cCC1101_Main( const cCC1101_Main &c );
	cCC1101_Main& operator=( const cCC1101_Main &c );
