...
// default constructor
cDHT22::cDHT22(char pin)
{
	//cDebug::Log(cDebug::LOG_E, "DHT22");
...
// disabled since I know we are slower than 2 secs
// 	if(currentTime - _lastReadTime < 2000)
// 	{
// 		// Caller needs to wait 2 seconds between each call to readData
// 		String sTemp="e: " + String(currentTime,DEC) + " " + String(_lastReadTime,DEC);
